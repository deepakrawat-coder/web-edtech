...
<div class="modal-header">
  <h3 class="modal-title">Add About Us </h3>
  <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
</div>

<div class="card-body">
  <div class="form-validation">
    <form class="needs-validation" role="form" id="form-add-blogs" action="/admin/app/aboutus/store" method="POST" enctype="multipart/form-data">
      <div class="row">
        ...
        <div class="mb-3 col-md-6">
          ...
          <input type="number" class="form-control" name="order_index" placeholder="Enter Order Index..">
        </div>
        ...
        <div class="mb-3 col-md-12">
          ...
          <textarea cols="2" class="form-control ckeditor" id="editor" name="description" placeholder="Enter a Description.." required></textarea>
        </div>
      </div>
