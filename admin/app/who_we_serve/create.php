...
<div class="card-body">
  <div class="form-validation">
    <form class="needs-validation" role="form" id="form-add-blogs" action="/admin/app/who_we_serve/store" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="mb-3 col-md-6">
          <label class="form-label">Client Name <span class="text-danger">*</span></label>
          <input type="text" class="form-control" name="client_name" placeholder="Enter a Client Name.." required>
        </div>
        ...
        <div class="mb-3 col-md-12">
          ...
          <input type="text" class="form-control" name="link_url" placeholder="Enter a Website Link..">
        </div>
        <div class="mb-3 col-md-12">
          <label class="form-label">Description <span class="text-danger">*</span></label>
          <textarea cols="2" class="form-control ckeditor" id="editor" name="description" placeholder="Enter a Short Description.." required></textarea>
        </div>
      </div>
