...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // ✅ Check duplicate
    $check = $conn->query("SELECT id FROM key_features WHERE title LIKE '$title'");
    ...
    // ✅ Insert new record
    $add = $conn->query("INSERT INTO key_features (title,message,product_id,image) VALUES ('$title','$message','$product_id','$filename')");
    if ($add) {
