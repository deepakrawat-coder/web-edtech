...
if (isset($_GET['id'])) {
  ...
  $id = intval($_GET['id']);
  $categoryPlains = $conn->query("SELECT * FROM service_about WHERE ID = $id");
...
<div class="card-body">
  <div class="form-validation">
    <form class="needs-validation" role="form" id="form-add-blogs" action="/admin/app/service/aboutService/update" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="mb-3 col-md-12 d-flex flex-column">
          ...
          <label class="custom-image-upload w-100" for="image">
            ...
            <input type="file" name="updateabout" id="image"
        ...
        $.ajax({
          ...
          success: function(data) {
            if (data.status == 200) {
              ...
              $('#aboutService-table').DataTable().ajax.reload(null, false);
            } else {
