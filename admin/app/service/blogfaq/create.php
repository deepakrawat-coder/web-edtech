...
<div class="card-body">
  <div class="form-validation">
    <form class="needs-validation" role="form" id="form-add-faq" action="/admin/app/service/blogfaq/store" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3 col-md-12">
        ...
        <select name="blog_id" id="blog_id" class="form-control " required>
          ...
          <?php
          while ($blog = $blogQuery->fetch_assoc()) {
