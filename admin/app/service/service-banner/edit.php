...
if (isset($_GET['id'])) {
  ...
  $id = intval($_GET['id']);
  $categoryPlains = $conn->query("SELECT * FROM hero_banner WHERE ID = $id");
...
<div class="card-body">
  <div class="form-validation">
    <form class="needs-validation" role="form" id="form-add-blogs" action="/admin/app/service/service-banner/update" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="mb-3 col-md-12 d-flex flex-column">
          ...
          <label class="custom-image-upload w-100" for="image">
            ...
            <input type="file" name="updatedbanner" id="image"
