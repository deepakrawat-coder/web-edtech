...
<!-- Mirrored from yashadmin.dexignzone.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 05:46:49 GMT -->
...
<head>
  ...
  <!-- PAGE TITLE HERE -->
  <title>EdTech Innovate</title>

  <!-- FAVICONS ICON -->
  <link rel="shortcut icon" type="image/png" href="/admin/admin-assets/images/edtech.png">
                ...
                <div class="login-form style-2">
                  ...
                  <div class="card-body">
                    <div class="logo-header">
                      <a href="#" class="logo"><img src="/admin/admin-assets/images/edtech.png" alt="" style="width: 56%;" class="width-100 light-logo"></a>
                      <a href="#" class="logo"><img src="/admin/admin-assets/images/edtech.png" alt="" style="width: 56%;" class="width-100 dark-logo"></a>
                    </div>
                      ...
                      <div class="nav nav-tabs border-bottom-0" id="nav-tab" role="tablist">
                        ...
                        <div class="tab-content w-100" id="nav-tabContent">
                          <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
                            <form id="form-login" role="form" autocomplete="off" action="app/login/login" class=" dz-form pb-3">
                              ...
                              <div class="form-group text-left mb-5 forget-main">
                                ...
                                <button class="nav-link m-auto btn tp-btn-light btn-primary forget-tab d-none" id="nav-forget-tab" data-bs-toggle="tab" data-bs-target="#nav-forget" type="button" role="tab" aria-controls="nav-forget" aria-selected="false">Forget Password ?</button>
                              </div>

                            </form>

                          </div>
                          <div class="tab-pane fade d-none" id="nav-forget" role="tabpanel" aria-labelledby="nav-forget-tab" >
                            <form class="dz-form">
                  ...
                  <div class="card-footer">
                    <div class=" bottom-footer clearfix m-t10 m-b20 row text-center">
                      <div class="col-lg-12 text-center">
                        <span> © Copyright 2024 EdTech. <span class="heart"></span>
