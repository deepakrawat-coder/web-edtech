                        ...
                        <div class="tab-pane fade show active" id="withoutBorder" role="tabpanel" aria-labelledby="home-tab-3">
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <table id="service-banner-table" class="display table" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <!-- <th>Video</th> -->
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#service-banner-table').DataTable({
            'processing': true,
            'ajax': {
                'url': '/admin/app/service/service-banner/server',
                'type': 'POST'
            },
            'columns': [{
                    data: 'No'
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<label class="switch" for="status-switch-' + row.ID + '"> <input onclick="changeStatus(&#39;hero_banner&#39;, &#39;' + row.ID + '&#39;)" type="checkbox" ' + checked + ' id="status-switch-' + row.ID + '"><span class="slider round"></span></label>';
                    },
                    visible: true
                },

                {
                    ...
                    render: function(data, type, row) {
                        return `
                                <div class="ms-auto">
                                    <a href="javascript:void(0);" onclick="edit('service/service-banner', '${row.ID}', 'md')" class="btn btn-primary btn-xs sharp me-1">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <a href="javascript:void(0);" onclick="destroy('service/service-banner', '${data}')" class="btn btn-danger btn-xs sharp">
