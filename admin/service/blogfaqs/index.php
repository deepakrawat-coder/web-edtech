                        ...
                        <div class="tab-pane fade show active" id="withoutBorder" role="tabpanel" aria-labelledby="home-tab-3">
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <table id="blogsfaq_service-table" class="display table" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Name</th>
...
<script type="text/javascript">
    ...
    var table = $('#blogsfaq_service-table').DataTable({
        'processing': true,
        'ajax': {
            'url': '/admin/app/service/blogfaq/server',
            'type': 'POST'
        },
        'columns': [
            { data: 'No' },
            ...
            { data:'Answer'},
            {
                ...
                render: function(data, type, row) {
                    ...
                    return '<label class="switch" for="status-switch-' + row.ID + '"> <input onclick="changeStatus(&#39;blogfaq_service&#39;, &#39;' + row.ID + '&#39;)" type="checkbox" ' + checked + ' id="status-switch-' + row.ID + '"><span class="slider round"></span></label>';
                },
                visible: true
            },
           
            {
                ...
                render: function(data, type, row) {
                //    console.log(data);
                    return '<div class="ms-auto"><a href="javascript:void(0);" onclick="edit(&#39;service/blogfaq&#39;, &#39;' + row.ID + '&#39, &#39;md&#39;)" class="btn btn-primary btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a><a href="javascript:void(0);" onclick="destroy(&#39;service/blogfaq&#39;, &#39;' + data + '&#39)" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a></div>';
                },
                visible: true
            },
        ],
